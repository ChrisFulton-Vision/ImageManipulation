...
class CalibrateGui(CTkFrame):
    ...
    def setup_imageFrame(self, master_frame):
        ...
        remove_unselected = CTkButton(master=header, text='Hide Unused',
                                      width=self.header_button_width('Hide Unused'),
        ...
        self.img_flip_protected_button = CTkButton(master=header, text='Flip All',
                                                        hover_color='navy', fg_color='blue',
                                                        width=self.header_button_width('All', has_image=True),
                                                        height=self.arrow_button_size,
                                                        command=self.unprotectFlip)
    ...
    def protectFlip(self, row=1):
        self.protectImageActionButton(self.img_flip_protected_button, self.unprotectFlip, row, 11)
